...
void MakeVertexBuffer(Vertex* vertices, int vertexCount, Microsoft::WRL::ComPtr<ID3D11Device> device, Microsoft::WRL::ComPtr<ID3D11Buffer> vertexBuffer)
{
...
void MakeIndexBuffer(unsigned int* indices, int indexCount, Microsoft::WRL::ComPtr<ID3D11Device> device, Microsoft::WRL::ComPtr<ID3D11Buffer> indexBuffer)
{
...
Mesh::Mesh(Vertex* vertices, int vertexCount, unsigned int* indices, int indexCount, Microsoft::WRL::ComPtr<ID3D11Device> device, Microsoft::WRL::ComPtr<ID3D11DeviceContext> deviceContext)
{
	...
	MakeVertexBuffer(vertices, vertexCount, device, this->vertexBuffer);
	MakeIndexBuffer(indices, indexCount, device, this->indexBuffer);
}



Mesh::Mesh(const wchar_t* fileName, Microsoft::WRL::ComPtr<ID3D11Device> device, Microsoft::WRL::ComPtr<ID3D11DeviceContext> deviceContext)
{
	// Author: Chris Cascioli 
	// THE OBJECT LOADING CODE BELOW IS NOT MINE, IT WAS DESIGNED BY CHRIS CASCIOLI
	// THE OBJECT LOADING CODE BELOW IS NOT MINE, IT WAS DESIGNED BY CHRIS CASCIOLI
	// THE OBJECT LOADING CODE BELOW IS NOT MINE, IT WAS DESIGNED BY CHRIS CASCIOLI
...
// File input object
	...
	//MakeVertexBuffer(&verts[0], vertCounter, device, this->vertexBuffer);
	D3D11_BUFFER_DESC vbd = {};
	vbd.Usage = D3D11_USAGE_IMMUTABLE;
	...
	//MakeIndexBuffer(&indices[0], indexCounter, device, indexBuffer);
	D3D11_BUFFER_DESC ibd = {};
	ibd.Usage = D3D11_USAGE_IMMUTABLE;
